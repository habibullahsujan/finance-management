    ...
    return (
        <Card className='border-none drop-shadow-sm'>
            ...
            <CardContent>
                ...
                <p className={cn('text-muted-foreground text-sm line-clamp-1', percentageChange > 0 && "text-emerald-500", percentageChange < 0 && "text-rose-500")}>{formatPercentage(percentageChange)} from last period</p>
            </CardContent>
        </Card>
    )
}
